package com.kuycoding.periksayook.ui.patient.appointment.camera;
...
public class CamActivity extends AppCompatActivity {
    ...
    private ImageView imgPreview, imgClear;
    private TextureView mTextureView;
    private RelativeLayout capture_button;
    private ImageButton btnTake;
    private RelativeLayout upload_button, box_container, close_stillshot_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        close_stillshot_view = findViewById(R.id.close_stillshot_view);
    ...
    private void saveUpload(File mFile) {
        btnUpload.setOnClickListener(v -> {
            Log.d(TAG, "saveUpload: "+ mFile.getAbsolutePath());
            Intent intent = new Intent(this, PatienMakeAppActivity.class);
            intent.putExtra("keyName", mFile.getAbsolutePath());
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile, close_stillshot_view, mTextureView, imgPreview, btnTake, capture_button, upload_button, box_container));
        }
    };
    ...
    private static class ImageSaver implements Runnable {
        ...
        private final RelativeLayout ViewClear;
        private final TextureView mTextureView;
        private final ImageView mPhotoPreview;
        private final RelativeLayout btnTake;
        private final RelativeLayout uploadBtn;
        private final RelativeLayout BoxContainer;

        ImageSaver(Image image, File file, RelativeLayout imageViewClear, TextureView textureView, ImageView photoPreview, ImageButton take, RelativeLayout btnTake, RelativeLayout upload_button, RelativeLayout box_container) {
            mImage = image;
            mFile = file;
            mTextureView = textureView;
            mPhotoPreview = photoPreview;
            this.ViewClear = imageViewClear;
            this.btnTake = btnTake;
            this.uploadBtn = upload_button;
            this.BoxContainer = box_container;
        }
        ...
        public void run() {
            ...
            Runnable myRunnable = new Runnable() {
                ...
                public void run() {
                    ...
                    Picasso.get().load(mFile).memoryPolicy(MemoryPolicy.NO_CACHE).into(mPhotoPreview);
                }
            };
